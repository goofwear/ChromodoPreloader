...
BEGIN_MESSAGE_MAP(CDefaultDlg, CDialog)
	...
	ON_COMMAND(ID_CONTEXTMENU_UNLOADFIREFOXPRELOADER, OnContextmenuUnloadChromodopreloader)
	ON_COMMAND(ID_CONTEXTMENU_INTERNETOPTIONS, OnContextmenuInternetoptions)
	ON_COMMAND(ID_CONTEXTMENU_ABOUTFIREFOXPRELOADER, OnContextmenuAboutChromodopreloader)
	ON_COMMAND(ID_CONTEXTMENU_UNLOADFIREFOX, OnContextmenuUnloadChromodo)
	ON_COMMAND(ID_CONTEXTMENU_RELOADFIREFOX, OnContextmenuReloadChromodo)
