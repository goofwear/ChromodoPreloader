/////////////////////////////////////////////////////////////////////////////
// Options Dialog - ChromodoPreloaderDlg.cpp
/////////////////////////////////////////////////////////////////////////////
...
void COptionsDlg::OnBrowse() {
	...
	bi.lpszTitle = _T("Chromodo Application Folder");
...
void COptionsDlg::OnOK() {
	CString			// String Variables
		szFFExe,	// chromodo.exe path
		szErrMsg;	// Error message resource
	HANDLE hFFExe;	// chromodo.exe CreateFile handle
...
BOOL COptionsDlg::OnInitDialog() {
	...
	// See if we can autofind Chromodo
	if (::GetLatestChromodoInstallDir(NULL)) {
